  ...
  return (
    <div className={poppins.variable}>
      ...
      <main className="pt-4">
        ...
        <div className="flex flex-col bg-white p-10 md:flex-row pb-10 md:shadow-xl justify-around gap-6 md:gap-10 md:items-stretch">
          <motion.div
            className="flex-shrink-0 w-full md:w-auto md:max-w-md h-auto md:h-auto"
          ...
          <motion.div
            className="flex-1 h-auto md:h-auto"
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
